...
class ExtendedKeysTest(unittest.TestCase):
    ...
    def test_child_private_key_derivation(self):
        ...
        self.assertEqual(child11.xpub, self.xpub11, f'incorrect child derivation: {self.path11}')
        self.assertEqual(child11.xprv, self.xprv11, f'incorrect child derivation: {self.path11}')
        self.assertEqual(child12.xpub, self.xpub12, f'incorrect child derivation: {self.path12}')
        self.assertEqual(child12.xprv, self.xprv12, f'incorrect child derivation: {self.path12}')
        self.assertEqual(child13.xpub, self.xpub13, f'incorrect child derivation: {self.path13}')
        self.assertEqual(child13.xprv, self.xprv13, f'incorrect child derivation: {self.path13}')
        self.assertEqual(child14.xpub, self.xpub14, f'incorrect child derivation: {self.path14}')
        self.assertEqual(child14.xprv, self.xprv14, f'incorrect child derivation: {self.path14}')
        self.assertEqual(child15.xpub, self.xpub15, f'incorrect child derivation: {self.path15}')
        self.assertEqual(child15.xprv, self.xprv15, f'incorrect child derivation: {self.path15}')
        self.assertEqual(child21.xpub, self.xpub21, f'incorrect child derivation: {self.path21}')
        self.assertEqual(child21.xprv, self.xprv21, f'incorrect child derivation: {self.path21}')
        self.assertEqual(child22.xpub, self.xpub22, f'incorrect child derivation: {self.path22}')
        self.assertEqual(child22.xprv, self.xprv22, f'incorrect child derivation: {self.path22}')
        self.assertEqual(child23.xpub, self.xpub23, f'incorrect child derivation: {self.path23}')
        self.assertEqual(child23.xprv, self.xprv23, f'incorrect child derivation: {self.path23}')
        self.assertEqual(child24.xpub, self.xpub24, f'incorrect child derivation: {self.path24}')
        self.assertEqual(child24.xprv, self.xprv24, f'incorrect child derivation: {self.path24}')
        self.assertEqual(child25.xpub, self.xpub25, f'incorrect child derivation: {self.path25}')
        self.assertEqual(child25.xprv, self.xprv25, f'incorrect child derivation: {self.path25}')
        self.assertEqual(child31.xpub, self.xpub31, f'incorrect child derivation: {self.path31}')
        self.assertEqual(child31.xprv, self.xprv31, f'incorrect child derivation: {self.path31}')
        self.assertEqual(child41.xpub, self.xpub41, f'incorrect child derivation: {self.path41}')
        self.assertEqual(child41.xprv, self.xprv41, f'incorrect child derivation: {self.path41}')
        self.assertEqual(child42.xpub, self.xpub42, f'incorrect child derivation: {self.path42}')
        self.assertEqual(child42.xprv, self.xprv42, f'incorrect child derivation: {self.path42}')
